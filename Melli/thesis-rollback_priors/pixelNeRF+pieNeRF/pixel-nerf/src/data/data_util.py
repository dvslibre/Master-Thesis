...
try:
    import torchvision.transforms.functional_tensor as F_t  # older import path
except ImportError:
    from torchvision.transforms import functional as F_t  # fallback for newer torchvision
